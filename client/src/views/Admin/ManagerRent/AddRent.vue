    ...
    <div class="container p-5">
        <div class="card form-register-car">
            <div class="card-header">
                Thêm phiếu đăng ký xe
            </div>
            <form class="p-5" method="post" @submit.prevent="onSubmitRegisterCarType(this.rent)">
                <div class="row py-2">
                    <div class="col">
                ...
                <div class="row py-4">
                    <div class="col">
                        ...
                        <select v-model="this.rent.ten_dichvu" @change="sortBy(this.rent.ten_dichvu)" name="service"
                    ...
                    <div class="col">
                        ...
                        <select v-model="this.rent.loaixe.so_cho" @change="sortByType(this.rent.loaixe.so_cho)" name="so_cho"
                            id="" class="form-select ">
                ...
                <div class="row py-2">
                    <div class="col">
                        ...
                        <input type="datetime-local" v-model="this.rent.ngaynhan" class="form-control" id="name"
                            required>
                    </div>
                    <div class="col">
